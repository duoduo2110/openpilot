...
class DeveloperLayoutSP(DeveloperLayout):
  ...
  def _initialize_items(self):
    ...
    self.enable_c3_web_toggle = toggle_item_sp(tr("C3 Web Service"),
                                                tr("Enables the LAN route browser and live camera service on port 8082."), param="EnableC3Web")
    ...
    self.items: list = [self.show_advanced_controls, self.enable_github_runner_toggle, self.enable_copyparty_toggle, self.enable_c3_web_toggle, self.prebuilt_toggle, self.error_log_btn,]
  ...
  def _update_state(self):
    ...
    self.enable_c3_web_toggle.set_visible(show_advanced)
